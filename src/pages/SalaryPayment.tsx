...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (term) filtered = filtered.filter(s => (s.EMPLOYEE.COMPANY_NM?.toLowerCase() || '').includes(term) || (s.EMP_NAME?.toLowerCase() || '').includes(term) || (s.EMP_LNAME?.toLowerCase() || '').includes(term) || (s.EMPLOYEE.NICK_NAME?.toLowerCase() || '').includes(term) || (s.TRANSFER_DATE?.toLowerCase() || '').includes(term));
